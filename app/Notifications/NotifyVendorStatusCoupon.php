...
class NotifyVendorStatusCoupon extends Notification
{
    use Queueable;
    use FcmFirebase;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $this->body_data = [
                'title'     =>  'لديك إشعار جديد خاص بالكوبونات',
                'text'      =>  'تم تغيير حالة الكوبون    '. $this->msg->text . ' إلي ' . __('main.coupons.'.$this->msg->status),
