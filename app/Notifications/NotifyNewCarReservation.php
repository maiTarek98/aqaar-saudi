...
class NotifyNewCarReservation extends Notification
{
    use Queueable;
    use FcmFirebase;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $this->body_data = [
                ...
                'text'      =>  'تم حجز السيارة رقم اعلان  '. $this->msg->car?->request_no,
                'redirect'  => 'cars/'. $this->msg->car_id.'#custom-content-above-profile-tab',
                'data'      =>  [ 
                    ],
