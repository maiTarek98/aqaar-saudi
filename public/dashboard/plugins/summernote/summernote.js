  ...
  var Editor = /** @class */ (function () {
      function Editor(context) {
          ...
          this.floatMe = this.wrapCommand(function (value) {
              ...
              $target.toggleClass('note-float-end', value === 'left');
              $target.toggleClass('note-float-start', value === 'right');
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          icons: {
              ...
              'floatLeft': 'note-icon-float-end',
              'floatRight': 'note-icon-float-start',
              'font': 'note-icon-font',
