    ...
    <div class="card-body">
        <div class="row g-3"> 
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="content_ar" class="form-control summernote @error('content_ar') is-invalid @enderror" id="content_ar">{{ old('content_ar', $item->content_ar) }}</textarea>
                <div class="help-block with-errors"></div>
            </div>
        </div>
        <div class="col-md-12">                      
            <div class="form-group">
                ...
                <textarea type="text" name="content_en" class="form-control summernote @error('content_en') is-invalid @enderror" id="content_en">{{ old('content_en', $item->content_en) }}</textarea>
                <div class="help-block with-errors"></div>
            </div>
        </div>
        <div class="col-md-12">                      
